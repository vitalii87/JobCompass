...
_INLINE_UK_TO_EN.update(
    {
        ...
        "Не вдалося підключитися до GitHub після повторних спроб: ": "Could not connect to GitHub after several attempts: ",
        "Не вдалося завантажити файл оновлення після повторних спроб. Перевірте інтернет-з’єднання або відкрийте сторінку релізу. ": "Could not download the update file after several attempts. Check your internet connection or open the release page. ",
