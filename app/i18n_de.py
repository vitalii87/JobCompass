...
INLINE_EN_TO_DE.update(
    {
        ...
        "Could not connect to GitHub after several attempts: ": "Nach mehreren Versuchen konnte keine Verbindung zu GitHub hergestellt werden: ",
        "Could not download the update file after several attempts. Check your internet connection or open the release page. ": "Die Aktualisierungsdatei konnte nach mehreren Versuchen nicht heruntergeladen werden. Prüfen Sie die Internetverbindung oder öffnen Sie die Release-Seite. ",
        "\n\nAutomatic download failed. Open the release page in your browser?": "\n\nDer automatische Download ist fehlgeschlagen. Release-Seite im Browser öffnen?",
